...
// Игрок и Противник
const g_enemy = new Rectangle(COLOR_BLACK, g_game.width / 2 - PLAYER_HEIGHT / 2, 0, PLAYER_WIDTH, PLAYER_HEIGHT);
const g_player = new Rectangle(COLOR_GREEN, g_game.width / 2 - PLAYER_HEIGHT / 2, g_game.height - PLAYER_HEIGHT, PLAYER_WIDTH, PLAYER_HEIGHT);
